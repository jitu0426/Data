...
CLOUDINARY_CLOUD_NAME = os.environ.get("CLOUDINARY_CLOUD_NAME", "dddtoqebz")
CLOUDINARY_API_KEY    = os.environ.get("CLOUDINARY_API_KEY",    "157864912291655")
CLOUDINARY_API_SECRET = os.environ.get("CLOUDINARY_API_SECRET", "YkhyT4hxge0fh-zACddSnsI0-S4")
